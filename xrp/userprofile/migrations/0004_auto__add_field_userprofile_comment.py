...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.comment'
        db.add_column(u'userprofile_userprofile', 'comment',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.comment'
        db.delete_column(u'userprofile_userprofile', 'comment')
