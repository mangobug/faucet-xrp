...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'userprofile_userprofile', 'role',
                      self.gf('django.db.models.fields.CharField')(default='st', max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.role'
        db.delete_column(u'userprofile_userprofile', 'role')
    ...
    models = {
        ...
        'userprofile.userprofile': {
            ...
            'role': ('django.db.models.fields.CharField', [], {'default': "'st'", 'max_length': '2', 'null': 'True', 'blank': 'True'}),
